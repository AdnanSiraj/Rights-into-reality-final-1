            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="mt-4 text-sm text-amber-600">
                  <span className="font-medium">Placeholder:</span> X students reached annually
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="mt-4 text-sm text-amber-600">
                  <span className="font-medium">Placeholder:</span> X trees planted yearly
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="mt-4 text-sm text-amber-600">
                  <span className="font-medium">Placeholder:</span> X community clean-ups conducted annually
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="mt-4 text-sm text-amber-600">
                  <span className="font-medium">Placeholder:</span> X individuals trained annually
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="mt-4 text-sm text-amber-600">
                  <span className="font-medium">Placeholder:</span> X youth leaders developed yearly
                </p>
              </div>
            </div>
          </div>
